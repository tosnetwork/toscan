...
<template>
  <div class="container page-container">
    ...
    <PageHeading title="Dispute" description="On-chain review of a contested autonomous-work outcome." eyebrow="Accountability"><StatusBadge :status="data?.data.status ?? 'indexed'" /></PageHeading>
