...
import { getToken } from "@/api/explorer";
...
<template>
  <div class="container page-container">
    <nav class="breadcrumbs" aria-label="Breadcrumb"><RouterLink to="/">Explorer</RouterLink><AppIcon name="chevron" :size="13" /><span>{{ kind }}</span></nav>
